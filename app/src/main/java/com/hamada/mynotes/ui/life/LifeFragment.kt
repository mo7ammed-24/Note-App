...
import com.hamada.mynotes.databinding.FragmentLifeBinding
...
class LifeFragment : BaseFragment<FragmentLifeBinding>(R.layout.fragment_life) {
    override val viewModel by activityViewModels<AllNotesViewModel>()
    override val bindingInflater: (LayoutInflater, Int, ViewGroup?, Boolean) -> FragmentLifeBinding
        get() = DataBindingUtil::inflate

    override fun setupView() {
        viewModel.getCategoryNotes("Life")
